...
<script>
  export default {
    ...
    methods: {
      ...
      sendGet() {
        this.$axios.get('http://18.191.214.175:3000/api/data/company')
                .then((res) => {
      ...
      sendPut() {
        this.$axios.put('http://18.191.214.175:3000/api/data/company')
                .then((res) => {
      ...
      sendDelete() {
        this.$axios.delete('http://18.191.214.175:3000/api/data/company')
                .then((res) => {
